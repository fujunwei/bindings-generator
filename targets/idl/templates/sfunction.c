...
$arg_wrapper
        ...
        $ret_impl_type ret_impl = String($namespaced_class_name::${func_name}($arg_wrapper_call).c_str());
        #else
        $ret_impl_type ret_impl = $namespaced_class_name::${func_name}($arg_wrapper_call);
        #end if
        $ret_cocos_instance
